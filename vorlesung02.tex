...
%		0 & \omega\not\in A.
	...
	\end{cases}
\end{equation*}
das Einpunktmaß oder \textbf{Dirac-Maß in $\omega$}.\\
...
\par\noindent $F$ heißt die zu $P$ gehörige \textbf{Verteilungsfunktion}.
...
\par\noindent $F$ ist Verteilungsfunktion eines W-Maßes $P$ auf $R$.

\par\noindent $f$ heißt \textbf{Wahrscheinlichkeitsdichte} (oder einfach "`Dichte"') von $P$.
