...
$X \sim \mathfrak{H}(a,r,n)$\\
				$X = \sum_{j=1}^n{I_{A_j}}$ \\
				$A_j$ ist das Ereignis ``Beim $n$-fachen Ziehen ohne Zurücklegen je einer Kugel aus einer Urne mit $r$ roten und $s=a-r$ schwarzen Kugeln und bei der $j$-ten Ziehung wird eine rote Kugel gezogen''.\\
				...
				Beim $n$-fachen Ziehen mit Zurücklegen je eine Kugel aus einer Urne mit  $r$ roten und $s=a-r$ schwarzen Kugeln ist Anzahl $X$ der gezogenen roten Kugeln $\mathfrak{B}(n,\frac{r}{a})$-verteilt, also
				\[ E(X)=n\cdot\frac{r}{a} \]
...
Sei $X \sim \mathfrak{B}(n,p)$. Dann wäre eigentlich
...
Sei $X \sim \mathfrak{H}(a,r,n)$. Dann wäre eigentlich
\[ Var(X) = \sum_{k=\max{(0,n+r-a)}}^{\min{(r,n)}}{(k-n\cdot\frac{r}{a})^2\cdot \frac{\binom{r}{k}\cdot\binom{a-r}{n-k} }{\binom{a}{n}}} \]
Wir vereinfachen das im Folgenden: O.B.d.A. fassen wir $X$ auf als die Anzahl der gezogenen roten Kugeln in $n$ Ziehungen bei $n$-fachem Ziehen ohne Zurücklegen je eine Kugel aus einer Urne mit $r$ roten und $s=a-r$ schwarzen Kugeln.\\
