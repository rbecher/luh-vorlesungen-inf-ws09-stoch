...
Eine reelle (oder $\{0,1\}$-wertige) Zufallsvariable $X$ heißt Binomailverteilt mit den Parametern $n\in\mathbb{N}$ und $p\in[0,1]$, wenn gilt
\begin{equation}
...
Sei $(\Omega,\mathfrak{A},P)$ W-Raum, $A\in \mathfrak{A}$ Ereignis. Dann heißt $I_A:\Omega \rightarrow \{0,1\}$ \textbf{Indikator} (oder Indikatorvariable) von $A$, definiert durch
