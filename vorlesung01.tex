...
\begin{itemize}
	...
	\textit{(Erklärung: \eqref{lab2.3.1} und äquivalent \eqref{lab2.3.2} kann man sich so vorstellen, dass man sich seine $r$-elementige Teilmenge (ohne Zurücklegen) zusammensuchen kann, aber die verschiedenen Möglichkeiten, sie zu permutieren (``die Kinobesucher umzusetzen''), interessieren den Betrachter hier nicht, also müssen wir die aus der Rechnung rausnehmen.)}
