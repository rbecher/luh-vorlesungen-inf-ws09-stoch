...
\begin{itemize}
	...
	\item Mit $A \in \mathfrak{A} \Leftrightarrow A^c \in \mathfrak{A}$.\\ (Wenn $\mathfrak{A}$ eine Teilmenge $A\in\Omega$ als mögliches Ergebnis enthält, dann auch deren Komplement $A^c=\Omega \setminus A$)
...
\end{enumerate}
	Im \textbf{Würfelwurf} seien beispielsweise gültige Ereignisse:
	\begin{itemize}
